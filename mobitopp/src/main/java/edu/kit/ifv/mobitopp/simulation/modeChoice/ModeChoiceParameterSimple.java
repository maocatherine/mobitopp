...
class ModeChoiceParameterSimple implements ModeChoiceParameter {
    ...
    public final Double bike_no_driving_license = Double.NaN;
    public final Double car_no_driving_license = Double.NaN;
    public final Double passenger_no_driving_license = Double.NaN;
    public final Double pt_no_driving_license = Double.NaN;
    ...
    private void init() {
        ...
        this.parameterBike.put("NO_DRIVING_LICENSE", bike_no_driving_license);
        ...
        this.parameterCar.put("NO_DRIVING_LICENSE", car_no_driving_license);
        ...
        this.parameterPassenger.put("NO_DRIVING_LICENSE", passenger_no_driving_license);
        ...
        this.parameterPt.put("NO_DRIVING_LICENSE", pt_no_driving_license);
    ...
    public Map<Mode, Map<String, Double>> gatherAttributes(
        ...
        double distance = Math.max(0.1, impedance.getDistance(originId, destinationId));
        ...
        double no_driving_license = !person.hasPersonalCar() && !person.hasAccessToCar() ? 1 : 0;
        ...
        attributes.put("NO_DRIVING_LICENSE", no_driving_license);

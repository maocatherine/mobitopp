...
public class VisumNetworkReader extends VisumBaseReader {
    ...
    public VisumNetworkReader(NetfileLanguage language, VisumFileReader visumReader) {
        super(language);
        stopWatch = new StopWatch(LocalDateTime::now);
        this.visumReader = visumReader;
    }
    ...
    public VisumNetworkReader() {
        this(StandardNetfileLanguages.defaultSystems().english());
    }

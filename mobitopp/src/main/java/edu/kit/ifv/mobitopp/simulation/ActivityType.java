...
public enum ActivityType {
    ...
    public boolean isFixedActivity() {
        return isFixedActivity(this);
    }

    public boolean isHomeActivity() {
        return isHomeActivity(this);
    }

    public boolean isShoppingActivity() {
        return isShoppingActivity(this);
    }

    public boolean isLeisureActivity() {
        return isLeisureActivity(this);
    }

    public boolean isWorkActivity() {
        return isWorkActivity(this);
    }

    public boolean isBusinessActivity() {
        return isBusinessActivity(this);
    }

    public boolean isEducationActivity() {
        return isEducationActivity(this);
    }

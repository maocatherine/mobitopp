...
public class DestinationChoiceModelTime
    ...
    protected Double coeff_time_nolicense = 0.00113082;
    ...
    public double calculateUtility(
        ...
        boolean license = person.hasDrivingLicense();
        ...
        double time_nolicense_coeff = license ? 0.0 : this.coeff_time_nolicense;
    ...
    public AgeGroup age(Person person) {
        ...
        if (age < 10) {
            ...
            return AgeGroup.AGE_10_17;
        } else if (age < 26) {
            return AgeGroup.AGE_18_25;
        } else if (age < 36) {
            return AgeGroup.AGE_26_35;
        } else if (age < 51) {
            return AgeGroup.AGE_36_50;
        } else if (age < 61) {
            return AgeGroup.AGE_51_60;
        } else if (age < 70) {
            return AgeGroup.AGE_61_70;
        } else {
            return AgeGroup.AGE_70_ABOVE;
        }
